...
See [`object-example.py`](https://github.com/OpenDataDSL/odsl-python-sdk-demo/blob/main/object-example.py), [`curve-example.py`](https://github.com/OpenDataDSL/odsl-python-sdk-demo/blob/main/curve-example.py), and [`full-example.py`](https://github.com/OpenDataDSL/odsl-python-sdk-demo/blob/main/full-example.py) for these in full, and [`manual-payload-example.py`](https://github.com/OpenDataDSL/odsl-python-sdk-demo/blob/main/manual-payload-example.py) for the same object/curve update written out as raw dicts, if you'd rather not depend on `odsl.types` at all.
